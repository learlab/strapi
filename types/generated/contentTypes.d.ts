...
export interface ApiApiKeyApiKey extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    Nickname: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    Role: Schema.Attribute.Enumeration<['developer', 'deployment']> &
      Schema.Attribute.Required;
...
export interface ApiChapterChapter extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    Volume: Schema.Attribute.Relation<'manyToOne', 'api::text.text'>;
    createdAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiExternalDashboardUriExternalDashboardUri
  extends Struct.CollectionTypeSchema {
...
export interface ApiQuizQuiz extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    QuizType: Schema.Attribute.Enumeration<['Open Book', 'Closed Book']> &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Open Book'>;
    createdAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::external-dashboard-uri.external-dashboard-uri': ApiExternalDashboardUriExternalDashboardUri;
