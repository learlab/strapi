...
export default {
  register(app) {
    ...
    app.customFields.register({
      ...
      pluginId: "constructed-response",
      type: "text",
      intlLabel: {
        id: "constructed-response.constructed-response.label",
        defaultMessage: "Constructed response",
      },
      intlDescription: {
        id: "constructed-response.constructed-response.description",
        defaultMessage: "Answer to your comprehension question",
      },
